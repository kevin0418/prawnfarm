...
"""
    ...
    Welcome to an exceptional investment opportunity, more than 10% yueld
    ...
    It is produced about 10-12 tons of prawn per hectore.
    Production is mainly Costco (70%) and fish market (30%) sales

    :blue[Future Development]
    The total area is 142 ha, and the aquaculture license area is 50 ha 
    and 70 ha is expected.
